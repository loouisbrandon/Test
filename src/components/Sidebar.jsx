...
const Sidebar = () => {
  ...
  return (
    <>
    <div className="md:flex hideen flex-col w-[240px] py-10 px-4 bg-[#191624]">
...
<div className={`absolute top-0 h-screen w-2/3 gb-gradient-to-tl from-white/10 tp-[#483d8b]
